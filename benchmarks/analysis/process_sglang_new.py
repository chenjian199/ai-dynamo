...
def main():
    ...
    sglang_new_dir = project_root / "benchmarks/results/sglang_new"
    plot_script = script_dir / "plot_itl_ttft.py"
    compare_script = script_dir / "compare_results.py"
    output_plot_dir = project_root / "benchmarks/results/sglang_plot"
    output_table_dir = project_root / "benchmarks/results/sglang_table"
