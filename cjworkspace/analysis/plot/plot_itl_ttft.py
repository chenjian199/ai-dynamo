...
def main():
    if len(sys.argv) < 3:
        ...
        print("  python plot_p90_itl_ttft.py "
              "cjworkspace/results/sglang/decode_20251029_075443.txt "
              "cjworkspace/results/sglang/disagg_20251029_094805.txt "
              "cjworkspace/results/sglang/p90_itl_ttft.png")
        sys.exit(1)
    ...
    default_output = project_root / "cjworkspace" / "results" / "sglang" / "p90_itl_ttft.png"
    out_png = Path(sys.argv[3]) if len(sys.argv) >= 4 else default_output
