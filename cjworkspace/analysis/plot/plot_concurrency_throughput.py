...
def plot_concurrency_throughput_compare(
    ...
    ax1.set_xlabel(xlabel, fontsize=12)
    ax1.set_ylabel('Request Throughput (req/s)', fontsize=12)
    ax1.set_title(f'Request Throughput vs Concurrency{title_suffix} ({agg_label} vs {disagg_label})', fontsize=14, fontweight='bold')
    ax1.legend(loc='best', fontsize=10)
    ax1.grid(True, alpha=0.3, linestyle='--')
    ...
    ax2.set_xlabel(xlabel, fontsize=12)
    ax2.set_ylabel('Output Token Throughput (tokens/s)', fontsize=12)
    ax2.set_title(f'Output Token Throughput vs Concurrency{title_suffix} ({agg_label} vs {disagg_label})', fontsize=14, fontweight='bold')
    ax2.legend(loc='best', fontsize=10)
    ax2.grid(True, alpha=0.3, linestyle='--')
